...
public class BFS {
    public static void main(String[] args) {/*构造各顶点*/
        ...
        graph.put('i', list_i);
        graph.put('y', list_y);
        graph.put('u', list_u);/*记录每个顶点离起始点的距离，也即最短距离*/
        HashMap<Character, Integer> dist = new HashMap<Character, Integer>();/*遍历的起始点*/
        char start = 's';/*调用广度优先方法*/
